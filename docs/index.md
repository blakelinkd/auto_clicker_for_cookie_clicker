---
layout: default
title: 🍪 Auto Clicker for Cookie Clicker (Steam Edition)
description: Advanced automation bot for the Steam version of Cookie Clicker
---
...
<div align="center" style="margin: 2rem 0;">
  <a href="https://github.com/blakelinkd/auto_clicker_for_cookie_clicker/releases" style="text-decoration: none;">
    <button style="background-color: #9146FF; color: white; border: none; padding: 1rem 2rem; font-size: 1.2rem; border-radius: 8px; cursor: pointer; display: inline-flex; align-items: center; gap: 0.5rem;">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
      Download Latest Release
    </button>
  </a>
  <p style="margin-top: 0.5rem; font-size: 0.9rem; color: #aaa;">Windows installer • All releases</p>
</div>
...
<div align="center" style="margin-top: 3rem; padding-top: 2rem; border-top: 1px solid #444; color: #888; font-size: 0.9rem;">
  <p>
    ...
    <a href="./DEVELOPER_RELEASE_GUIDE.md">Release Guide</a> •
    <a href="./INSTALLER_LOG.md">Installer Log</a> •
    <a href="./REFACTOR_LOG.md">Refactor Log</a> •
